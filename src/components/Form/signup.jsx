...
function Signup() {
  ...
  const [lname,setlname] = useState();
   ...
   const handleSubmit = e =>{
    ...
    setPassword('');
    setcpassword('');
    setErrors(Validation(fname,lname,username,cpassword, password, email));
    ...
    <div>
      <div className='h-[100vh] w-[30vw] bg-[white] ml-auto mr-auto mt-20' id='signupp'>
       ...
       <form action="" onSubmit={handleSubmit}>
         ...
         <input type="text" value={fname} onChange={handlefnameChange} placeholder='First name ' className='ml-10  bg-[white] border-b-2 pl-2 border-b-violet-400 outline-none'/>
         {errors.fname && <p className="error text-[red] pl-10">{errors.fname}</p>}
         <label htmlFor=""  className='pl-10'>Last name</label>
         <input type="text" value={lname} onChange={handlelnameChange} placeholder='Last name' className='ml-10  bg-[white] border-b-2 pl-2 border-b-violet-400  outline-none'/>
         ...
         <input type="password" value={cpassword} onChange={handlecpassordChange} placeholder='Confirm password' className='ml-10  bg-[white] border-b-2 pl-2 border-b-violet-400  outline-none'/>
